...
- download as zip and extract to Extensions folder (you can find this by going to file --> open user support directory. If there is no extensions folder there, make one.) 
